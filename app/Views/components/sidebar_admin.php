...
<div class="w-64 bg-white border-r border-gray-200 flex flex-col hidden md:flex">
    ...
    <nav class="flex-1 space-y-1 px-2 mt-2">
        ...
        <?php if(session()->get('role') === 'admin'): ?>
            ...
            <a href="<?= base_url('admin/logs') ?>" class="flex items-center space-x-3 w-full px-4 py-2 rounded-r-full font-medium transition-colors <?= (strpos($uri, 'logs') !== false) ? 'bg-blue-100 text-blue-700' : 'text-gray-600 hover:bg-gray-100' ?>">
